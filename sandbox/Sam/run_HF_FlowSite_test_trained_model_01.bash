...
#SBATCH --mem=32G
#SBATCH -o /n/groups/marks/users/samhuang/projects/MLCB2023_Final_Project/sandbox/Sam/logs/run_HF_FlowSite_test_trained_model_01_%j.out                 # File to which STDOUT will be written, including job ID (%j)
#SBATCH -e /n/groups/marks/users/samhuang/projects/MLCB2023_Final_Project/sandbox/Sam/logs/run_HF_FlowSite_test_trained_model_01_%j.err                 # File to which STDERR will be written, including job ID (%j)
