...
output_file="/home/samhuang/Documents/GitHub/MLCB2023_Final_Project/sandbox/Sam/desktop/logs/run_test_HarmonicFlow_timesplit_DistPock_$(date +"%Y%m%d_%H%M%S").out"
error_file="/home/samhuang/Documents/GitHub/MLCB2023_Final_Project/sandbox/Sam/desktop/logs/run_test_HarmonicFlow_timesplit_DistPock_$(date +"%Y%m%d_%H%M%S").err"
